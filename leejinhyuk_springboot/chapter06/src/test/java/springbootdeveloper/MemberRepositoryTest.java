...
/*
    ...
    test -> resources -> insert-members.sql 파일 생성
    작성 후(혹은 확인 후에) 코드 의미 :
        src/main/resources 폴더 내에 있는 data.sql 파일을 자동 실행 못하게 하는 코드
    이제 MemberRepoistoryTest.java 파일 코드 작성
 */
@DataJpaTest
class MemberRepositoryTest {
    ...
    /*
        수정 메서드
        ex) id가 2인 멤버의 이름을 "BC"로 바꾼다 가정했을 때,
        ...
        JPA에[서 데이터를 수정하는 방식은 추후에 SQL에서 배우게 될 트랜잭션
        내에서 데이터를 수행해야 합니다.
