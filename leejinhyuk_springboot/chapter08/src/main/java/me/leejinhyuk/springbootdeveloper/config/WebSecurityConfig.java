package me.leejinhyuk.springbootdeveloper.config;

import lombok.RequiredArgsConstructor;
import me.leejinhyuk.springbootdeveloper.service.UserDetailService;
...
/*
    ...
    4. 폼 기반 로그인을 설정
        ...
        defaultSuccessUrl() : 로그인이 완료되었을 떄 이동할 경로를 설정 -> /articles

    5. 로그아웃 설정.
        logoutSuccessUrl() : 로그아웃이 완료되었을 때 이동할 경로를 설정
        invalidHttpSesstion() : 로그아웃 이후에 세션을 전체 삭제할지 여부를 설정 -> 저희는 true 설정
