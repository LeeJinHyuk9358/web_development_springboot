...
/*
    1. 스프링 부트 3 구조 살펴보기
        ...
        ex) 카페와 빵집
            ...
            어떤 손님이 커피를 사면 빵을 할인해 줄 수는 있음 -> 게층 간 소통
            ...
            2) 비지니스(Business)
                모든 비지니스 로직을 처리
                    * 비지니스 로직 : 서비스를 만들기 위한 로직을 의미하며, 웹 사이트에서 벌어지는
                        모든 작업 -> 주문 서비스라고 ㅎ나다면 주문 개수, 가격 등의 데이터를 처리하기
    ...
    스프링 부트 프로젝트 디렉토리 구성
        : 스프링 부트에는 정해진 구조가 없지만, 추천 프로젝트 구조가 있고, 이를 많은 개발자들이 따르므로
            ...
            test : 프로젝트의 소스 코드를 테스트할 목적의 코드나 리소스 파일이 들어있음
                (원래는 자동성생되는데 어제 제가 만들었을 때 안만들어지는 걸로 보아 설정 따라
                다른듯합니다)
    ...
    지시사항
        프레젠테이션, 서비스, 퍼시스턴스 계층 만들기
            ...
            1. 프레젠테이션 게층에 속하는 컨트롤러 관련 코드를 작성 -> TestController가 있으므로 생략
        ...
        작동을 확인해보겠습니다.
            ...
            04 단계 - Postman에서 HTTP 요청을 시도 해봅니다.
                1) 포스트맨 실행
